...
public class Homepage {
	...
	def validateCookies() {
		...
		TestObject cookieBanner = findTestObject("Cookies/Yes")
	...
	def validateMenuItemNavigation() {
		...
		Map<TestObject, TestObject> navigationMap = [
			...
			(findTestObject("Homepage/Menu_items/news"))             : findTestObject("Homepage/Menu_items/Navigation_links/News"),
	...
	def validateMenuItemNavigationmbl() {
		
				boolean allPassed = true
		
				// Define menu items and their expected navigation targets
				Map<TestObject, TestObject> navigationMap = [
					(findTestObject("Homepage/Menu_items_mbl/our_specialities")) : findTestObject("Homepage/Menu_items/Navigation_links/Learn_more"),
					(findTestObject("Homepage/Menu_items_mbl/our_brands"))       : findTestObject("Homepage/Menu_items/Navigation_links/A"),
					(findTestObject("Homepage/Menu_items_mbl/support_services")) : findTestObject("Homepage/Menu_items/Navigation_links/Support_services"),
					(findTestObject("Homepage/Menu_items_mbl/news"))             : findTestObject("Homepage/Menu_items/Navigation_links/News"),
					(findTestObject("Homepage/Menu_items_mbl/device_online"))    : findTestObject("Homepage/Menu_items/Navigation_links/Device_online"),
					(findTestObject("Homepage/Menu_items_mbl/about_us"))         : findTestObject("Homepage/Menu_items/Navigation_links/Company_review")
				]
			...
			def validateMenuItemNavigationmblNz() {
	...
	def validatePolicyLibrary() {
		...
		for(int i = 1;i<=Expected_policy_list.size();i++) {
			def policy_list_item = WebUI.getText(findTestObject("Object Repository/Homepage/FooterLinks/policy_list", [('i') : i]))
			assert policy_list_item in Expected_policy_list, policy_list_item+"not found."

			WebUI.click(findTestObject("Object Repository/Homepage/FooterLinks/policy_list", [('i') : i]))
	...
	def validateReturnsPolicy() {
		...
		WebUI.click(findTestObject("Object Repository/Homepage/FooterLinks/ReturnsPolicy"))
		// Get the page title
		String pageTitle = WebUI.getWindowTitle()
		...
		WebUI.verifyElementPresent(findTestObject("Object Repository/Homepage/FooterLinks/return_policy_text"),5)
