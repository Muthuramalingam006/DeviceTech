...
public class CategoryPage {
	...
	def validateCategoryNavigationBar() {
		...
		//WebUI.verifyElementPresent(findTestObject("Homepage/Menu_items/Navigation_links/LearnMore"),5)
		...
		WebUI.delay(3)
		WebUI.click(findTestObject("IphoneDevice/Agree"))
		WebUI.delay(3)
	...
	def validateContatcUs() {
		...
		WebUI.click(findTestObject("CatNavBar/State"))
		WebUI.click(findTestObject("CatNavBar/State"))
	...
	def validateDeviceOnline() {
		...
		WebUI.verifyElementPresent(findTestObject("CatNavBar/h3"), 2)
		WebUI.verifyElementPresent(findTestObject("CatNavBar/P5"), 2)
		WebUI.verifyElementPresent(findTestObject("CatNavBar/LearnMore"), 2)
		//Verify and click the Learn More element
		//WebUI.verifyElementPresent(findTestObject("CatNavBar/LearnMore"), 2)
		WebUI.click(findTestObject("CatNavBar/LearnMore"))
		...
		/*		// Validate the URL
		 if (currentUrl == "https://w3q.device.com.au/deviceonline") {
	...
	def validateAboutSection() {
		...
		if (WebUI.verifyElementPresent(findTestObject("CatNavBar/CriticalCare"), 2, FailureHandling.OPTIONAL)) {
			...
			WebUI.comment("🩺 SCM-63 - Pass : Cardiology text: " + text)
		} else {
			WebUI.comment("❌ SCM-63- Fail:  Cardiology element not found.")
			assert false : "Cardiology section missing from CatNavBar."
		}
	}
	...
	def validateBrandsSection() {
		...
		TestObject atrion = findTestObject("CatNavBar/CriticalCareBrands/Flexicare")
		TestObject balt = findTestObject("CatNavBar/CriticalCareBrands/SLE")
		TestObject bentley = findTestObject("CatNavBar/CriticalCareBrands/Medin")

		// Step 3: Verify presence of all elements
		boolean allPresent = WebUI.verifyElementPresent(heading, 2, FailureHandling.OPTIONAL) &&
				WebUI.verifyElementPresent(atrion, 2, FailureHandling.OPTIONAL) &&
				WebUI.verifyElementPresent(balt, 2, FailureHandling.OPTIONAL) &&
				WebUI.verifyElementPresent(bentley, 2, FailureHandling.OPTIONAL)
