...
public class News {
	...
	def validateNews() {
		...
		WebUI.click(findTestObject("IphoneDevice/Menu_items/news"))
		...
		KeywordUtil.logInfo(" Validate that all visible news items are tagged with 'Hospital Medical Technology & Services '")
