...
public class CategoryPage {
	...
	def validateCategoryNavigationBar() {
		...
		WebUI.verifyElementPresent(findTestObject("CatNavBar/ScrollCriticalCare"),5)
		WebUI.delay(3)
		WebUI.click(findTestObject("CatNavBar/ScrollCriticalCare"))
		WebUI.delay(4)

		WebUI.scrollToPosition(600,700)
		WebUI.delay(2)
		// Scroll to the element
		WebUI.scrollToElement(findTestObject("Tab/Agree"), 5)

		// Verify the element is present
		if (WebUI.verifyElementPresent(findTestObject("Tab/Agree"), 5)) {
			// Click the element
			WebUI.click(findTestObject("Tab/Agree"))
		} else {
			WebUI.comment("⚠️ Element 'Agree' not found or not visible.")
		}
