...
public class SupportServices {
	...
	def validateSupportServices() {
		...
		WebUI.verifyElementPresent(findTestObject("SupportService/RegulatoryParagraphNZ"), 2)
		...
		WebUI.comment("✅ SCM-98 - Pass : Support services all elements present.")
	}

	def validateTechinicalServices() {

		KeywordUtil.logInfo("Starting ' Validate SupportServices ' scenario...")
		WebUI.delay(10)
		WebUI.click(findTestObject("Homepage/Menu_items/support_services"))
		...
		WebUI.verifyElementPresent(findTestObject("SupportService/AboutNZ"), 2)
	...
	def validateDigitalEducation() {
		...
		WebUI.comment("✅ SCM-103 - Pass : Support services -Digital education all elements present.")
	}
}
