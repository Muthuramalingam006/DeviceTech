...
public class ContactUs {
	...
	def validateContent() {
		...
		WebUI.verifyElementPresent(findTestObject("ContactUsNZ/Auckland"),2)
		 ...
		 */
		WebUI.verifyElementPresent(findTestObject("ContactUsNZ/Auckland_subheading"),2)
	...
	def validateMapAddress() {
		...
		boolean addressVisible = WebUI.verifyElementVisible(findTestObject('ContactUsNZ/Auckland'), FailureHandling.CONTINUE_ON_FAILURE)
