...
public class DevicesOnline {
	...
	def validateDevicesOnline() {
		...
		WebUI.verifyElementPresent(findTestObject("NZ/EquipmentDescription"),5)
		...
		WebUI.verifyElementPresent(findTestObject("NZ/VastRangeDescription"),5)
		...
		//WebUI.verifyElementPresent(findTestObject("DeviceOnline/Invoices"),5)
		...
		//WebUI.verifyElementPresent(findTestObject("DeviceOnline/OrderStatus"),5)
		//WebUI.verifyElementPresent(findTestObject("DeviceOnline/Education"),5)
		...
		WebUI.back()
		//07232026WebUI.click(findTestObject("DeviceOnline/register_now_business"))
		//07232026WebUIWebUI.verifyElementPresent(findTestObject("DeviceOnline/register_now_business_navigation"),5)
	...
	def validateStickyBarDeviceOnline() {
		...
		WebUI.verifyElementPresent(findTestObject("NZ/Login"),5)
